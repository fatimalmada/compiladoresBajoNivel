...
void insertTablaSimbolos(const char *s, int n, const char *a)
{
	entrada e;
	strcpy(e.lexema,s);
	e.compLex=n;
	// inserta el nombre del componente lexico
	strcpy(e.complex_cadena,a);
	insertar(e);
}
...
void initTablaSimbolos()
{
	...
	insertTablaSimbolos("true",BOOL,"PR_TRUE");
	insertTablaSimbolos("TRUE",BOOL,"PR_TRUE");
	insertTablaSimbolos("false",BOOL,"PR_FALSE");
	insertTablaSimbolos("FALSE",BOOL,"PR_FALSE");
	insertTablaSimbolos("null",NULL_VALUE,"PR_NULL");
	insertTablaSimbolos("NULL",NULL_VALUE,"PR_NULL");
}
